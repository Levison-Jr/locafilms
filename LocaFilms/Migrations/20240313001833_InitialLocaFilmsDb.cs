...
{
    /// <inheritdoc />
    public partial class InitialLocaFilmsDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberPhysicalMedia = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieRentals", x => new { x.UserId, x.MovieId });
                    table.ForeignKey(
